...
//           <time dateTime="2020-03-16" className="text-gray-500">{blog.date}</time>
//           <a href="#" className="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100">{blog.tag}</a>
//         </div>
...
//               </a>
//             </p>
//             <p className="text-gray-600"> {blog.writerTitle}</p>
//           </div>
//         </div>
//       </article>
//       ))}
